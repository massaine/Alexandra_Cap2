...
## Analise de variancia Individual (tabela 3)
...
dados <- read.table(here::here("data", "Planilha epocas Fev23.txt"), header=T, sep="\t", na.strings="NA")
...
dados1 <- read.table(here::here("data", "DadosEpocas_NotaFloresV3.txt"), header=T, sep="\t", na.strings="NA", strip.white=TRUE, check.names=FALSE)
...
## Analise de variancia conjunta (tabela 3)
```{r}
